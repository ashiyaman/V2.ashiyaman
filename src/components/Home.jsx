...
const Home = () => {
  ...
  return (           
    <section className="my-4 px-5 md:my-8 lg:my-5">
        <p className="text-slate-400 py-3 md:py-3 text-xl md:text-3xl lg:py-3">
        <b>Hi, My Name is</b>{" "}
        </p>
        <h1 className="text-red-400 md:text-6xl py-3 md:py-3 text-4xl lg:py-3"><b>Ashiya Banu.</b></h1>
